...
<div class="berjalan">
  <marquee behavior="scroll" direction="left">selamat datang di website saya,di hari <?php echo date("l M Y");           ?></marquee>
</div>
<div class="row">
  <div class="col-lg-6">

    <h3 text-align="center">Daftar Mahasiswa</h3>
    ...
    <ul class="list-group">
      <?php foreach ($data['mhs'] as $mhs) : ?>
        <li class="list-group-item">
          ...
          <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id'];   ?>" class="badge badge-warning float-right ml-1 tampilModalUbah" data-toggle="modal" data-target="#fromModal" data-id="<?= $mhs['id']; ?>">ubah</a>
